...
getgenv()['Check_Setting'] = function(Name)
    ...
    if not _G.Dis and not isfile('EZ HUb BF Premium/'..Name..'.json') then
        writefile('Switch Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Ez Hub BF Premium') and isfile('Switch Hub BF Premium/'..Name..'.json') then
